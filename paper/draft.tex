...
\paragraph{Evaluation and Weak Supervision} There is no predictive task for COCO-Captions. Instead we measure the marginal loglikelihood for weak supervision tests. 
