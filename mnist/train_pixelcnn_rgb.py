"""Like PixelCNN but we respect color channels for RGB."""
...
if __name__ == "__main__":
    ...
    if not os.path.isdir('./trained_models/rgb_pixel_cnn'):
        os.makedirs('./trained_models/rgb_pixel_cnn')
    ...
    for epoch in xrange(args.epochs):
        ...
        }, is_best, folder='./trained_models/rgb_pixel_cnn')     
